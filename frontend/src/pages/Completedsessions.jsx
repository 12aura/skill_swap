...
const CompletedSessions = () => {
  ...
  return (
    <div className={`min-h-screen ${dm ? "bg-slate-900 text-white" : "bg-slate-50 text-slate-900"}`}>
     <main className="max-w-6xl mx-auto px-6 pt-10 pb-14">

  {/* BIG HEADING */}
  <div className="mb-10">
    <h1 className="text-5xl font-extrabold tracking-tight leading-tight">
      <span className={dm ? "text-white" : "text-slate-900"}>Skills </span>
      <span className="text-teal-500">Shared</span>
    </h1>

    <p className={`mt-2 text-sm ${dm ? "text-slate-400" : "text-slate-500"}`}>
