...
//   return (
//     <div className="bg-base-100 border border-base-300 rounded-2xl p-4 flex flex-col gap-3 shadow-sm">
...
//           )}
//           <div>
//             <p className="text-base-content text-sm font-medium">{reviewerName}</p>
...
//           </div>
//         </div>
//         <span className="text-base-content/50 text-xs">{timeAgo(createdAt)}</span>
//       </div>
...
//       {/* Skill pill */}
//       {skillName && (
//         <span className="self-start text-xs bg-primary/10 border border-primary/20 text-primary px-2 py-0.5 rounded-full">
//           {skillName}
//         </span>
//       )}
...
//       {/* Comment */}
//       {comment && (
//         <p className="text-base-content/80 text-sm leading-relaxed border-t border-base-300 pt-3">
//           "{comment}"
//         </p>
//       )}
//     </div>
