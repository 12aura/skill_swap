...
//         <>
//           {/* Summary Card */}
//           <div className="bg-white dark:bg-[#0f1a17] border border-gray-200 dark:border-[#1e3a2f] rounded-2xl p-5 flex flex-col sm:flex-row gap-6 shadow-sm">
...
//               {breakdown.map(({ star, count, pct }) => (
//                 <div key={star} className="flex items-center gap-2 text-xs">
//                   <span className="text-gray-500 dark:text-gray-400 w-3">
//                     {star}
//                   </span>

//                   <span className="text-yellow-400">★</span>

//                   <div className="flex-1 bg-gray-200 dark:bg-[#1a2e24] rounded-full h-2 overflow-hidden">
//                     <div
//                       className="bg-yellow-400 h-2 rounded-full transition-all duration-500"
//                       style={{ width: `${pct}%` }}
//                     />
